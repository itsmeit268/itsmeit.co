...
export default function Active() {
	...
	return (
		<StyledPageContainer>
			...
			<StyledPagination>
				<Button disabled={ ! queryHasPrevPage } icon={ chevronLeftSmall } variant="tertiary" onClick={ getPrev } text={ __( 'Prev', 'it-l10n-ithemes-security-pro' ) } />
				<Button disabled={ ! queryHasNextPage } icon={ chevronRightSmall } iconPosition="right" variant="tertiary" onClick={ getNext } text={ __( 'Next', 'it-l10n-ithemes-security-pro' ) } />
			</StyledPagination>
		</StyledPageContainer>
	);
}
