				...
				renderContent={ () => (
					...
					>
						...
						<FiltersGroupCheckboxes
							...
							options={ [
								{ value: '1', label: __( 'Very Weak', 'it-l10n-ithemes-security-pro' ) },
								{ value: '2', label: __( 'Weak', 'it-l10n-ithemes-security-pro' ) },
								{ value: '3', label: __( 'Medium', 'it-l10n-ithemes-security-pro' ) },
								{ value: '4', label: __( 'Strong', 'it-l10n-ithemes-security-pro' ) },
							] }
						/>
						<FiltersGroupDateRange
							slug="solid_password_age"
							title={ __( 'Password Age', 'it-l10n-ithemes-security-pro' ) }
							presets={ [
								{
									value: 604800,
									label: __( '7 days old', 'it-l10n-ithemes-security-pro' ),
									summary: __( 'Password is 7 days old', 'it-l10n-ithemes-security-pro' ),
								},
								{
									value: 2592000,
									label: __( '30 days old', 'it-l10n-ithemes-security-pro' ),
									summary: __( 'PW is 30 days old', 'it-l10n-ithemes-security-pro' ),
								},
								{
									value: 7776000,
									label: __( '90 days old', 'it-l10n-ithemes-security-pro' ),
									summary: __( 'PW is 90 days old', 'it-l10n-ithemes-security-pro' ),
								},
							] }
							allowCustom
						/>
