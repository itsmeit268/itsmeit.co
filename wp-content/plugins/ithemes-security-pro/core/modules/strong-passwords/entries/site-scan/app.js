			...
			<SiteScanIssue key={ issue.id } issue={ issue } icon={ shield }>
				<ScanIssueDetailContent>
					<ScanIssueDetailColumn>
						...
						<Text text={ __( 'Passwords are the first line of defense to your site’s security. Enable Strong Password enforcement to require users to setup a strong password.', 'it-l10n-ithemes-security-pro' ) } />
					</ScanIssueDetailColumn>
				</ScanIssueDetailContent>
