...
class ITSEC_User_Security_Check {
	...
	public function check_inactive_accounts( $sent, $last_sent ) {
		...
		$tracking_link = ITSEC_Core::is_pro()
			? 'https://go.solidwp.com/security-inactive-users-email-ithemes-becoming-solidwp'
			: 'https://go.solidwp.com/security-free-inactive-users-email-ithemes-becoming-solidwp';
