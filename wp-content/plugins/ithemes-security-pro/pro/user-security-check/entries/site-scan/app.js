				...
				<ScanIssueDetailColumn>
					...
					<Text text={
						sprintf(
							...
							__( 'If the user no longer needs %s access, you can remove them from the site. Alternatively, you can reduce their privilege to Author capabilities.', 'it-l10n-ithemes-security-pro' ),
							userRole
						)
					}
					/>
