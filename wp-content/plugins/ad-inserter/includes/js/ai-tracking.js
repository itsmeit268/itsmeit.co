...
//          var matches = navigator.userAgent.match(/(msie) ([\w.]+)/i);
        ...
        $("body").append('<div style="position:fixed; top:0; left:0; overflow:hidden;"><input style="position:absolute; left:-300px;" type="text" value="" id="focus_retriever" aria-label="Invalid protector" readonly="true" /></div>');
        ...
        $(document).mousemove(function(e) {
          if (document.activeElement && document.activeElement.tagName === "IFRAME") {
            ...
            if (process_iframe /*&& !document.activeElement.hasAttribute ('id') || $(document.activeElement).attr ('id').indexOf ('dsq-') !== 0*/) {
              // ### /AI
...
jQuery(document).ready(function($) {
  ...
  if (ai_debug_tracking) {
    ajax_url = ajax_url + '?ai-debug-tracking=1';
  }
  ...
  function replace_tags (text, event, block, block_name, block_counter, version, version_name, username) {
