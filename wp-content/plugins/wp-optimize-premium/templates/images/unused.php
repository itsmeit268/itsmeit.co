...
<div id="wpo-unused-images-section">
	...
	<div class="wpo-unused-images-section-loaded wpo_hidden">
		...
		<div class="wp-optimize-images-download-csv wpo-unused-images-el">
			<a href="<?php echo esc_url(add_query_arg(array('wpo_unused_images_csv' => '1', '_nonce' => wp_create_nonce('wpo_unused_images_csv')))); ?>"><?php esc_html_e('Download as CSV', 'wp-optimize'); ?></a>
		</div>
		...
		<div class="wpo-fieldgroup">
			...
			<div class="wpo_remove_selected_sizes_btn__container">
				<div class="notice notice-warning wpo-warning">
					<p>
						<span class="dashicons dashicons-shield"></span>
						<?php esc_html_e("This feature is for experienced users. Don't remove registered image sizes if you are not sure that images with selected sizes are not used on your site.", 'wp-optimize'); ?>
					</p>
				</div>
