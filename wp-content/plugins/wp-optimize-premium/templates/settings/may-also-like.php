...
<div class="wpo-plugin-family__premium">
	...
	<div class="wpo-plugin-family__plugins">
		<div class="wpo-plugin-family__plugin">
			...
			<p>
				<?php esc_html_e("Hacking, server crashes, dodgy updates or simple user error can ruin everything.", 'wp-optimize');?>
			</p>
			<p>
				<?php esc_html_e("With UpdraftPlus, you can rest assured that if the worst does happen, it's no big deal. rather than losing everything, you can simply restore the backup and be up and running again in no time at all.", 'wp-optimize');?>
			</p>
			<p>
		...
		<div class="wpo-plugin-family__plugin">
		<?php
			$wp_optimize->wp_optimize_url('https://updraftplus.com/updraftcentral/', null, '<img class="addons" alt="'.esc_attr__("UpdraftCentral Dashboard
	", 'wp-optimize').'" src="'. esc_url(WPO_PLUGIN_URL.'images/features/updraftcentral_logo.png') .'">');
			...
			<?php
				...
				$wp_optimize->wp_optimize_url('https://updraftplus.com/updraftcentral/', null, esc_html__('Try for free', 'wp-optimize'));
			}
			?>
		</div>
	</div>
