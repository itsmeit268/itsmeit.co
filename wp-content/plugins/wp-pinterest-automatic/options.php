	...
	// SAVE DATA
	if (isset ( $_POST ['wp_pinterest_automatic_session'] ) && current_user_can('administrator')  ) {
	...
	$wp_pinterest_pin_method = get_option('wp_pinterest_pin_method','');
			...
			<div class="inside">
		 			...
		 			<table class="form-table">
							<tbody>
								...
								<tr>
									<th scope="row"><label> Pin Method  </label></th>
									<td> 
										<select  name="wp_pinterest_pin_method">
										
										 	<option value="scraped" <?php @wp_pinterest_automatic_opt_selected('scraped', $wp_pinterest_pin_method ) ?>>Save from a website</option>
											<option value="uploaded" <?php @wp_pinterest_automatic_opt_selected('uploaded', $wp_pinterest_pin_method ) ?>>Create a pin</option>
											
										</select><div class="description">Save from a website: Pinterest will load your link and get the title and description, supports Rich Pins<br><br>Create a pin: like if you upload the image, set a title and description then click create<br><br>*Important: Only Create a pin will consider your custom title and description below</div>
									</td>
								</tr>
