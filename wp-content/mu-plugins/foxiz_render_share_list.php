<?php
/**
 * Plugin Name: Foxiz Render Share list
...
if ( ! function_exists( 'foxiz_render_share_list' ) ) {
    ...
    function foxiz_render_share_list( $settings = [] ) {
        ...
        if ( ! empty( $settings['flipboard'] ) ) :
            ?>
            <a rel="nofollow noopener" class="share-action share-trigger icon-flipboard" aria-label="<?php esc_attr_e('Share on Flipboard', 'foxiz-core'); ?>" href="https://share.flipboard.com/bookmarklet/popout?url=<?php echo urlencode( $permalink ); ?>" data-title="Flipboard"<?php echo esc_html( $tipsy_gravity ); ?> rel="nofollow">
        ...
        if ( ! empty( $settings['pinterest'] ) ) :
            ...
            <a rel="nofollow noopener" class="share-action share-trigger share-trigger icon-pinterest" aria-label="<?php esc_attr_e('Share on Pinterest', 'foxiz-core'); ?>" rel="nofollow" href="https://pinterest.com/pin/create/button/?url=<?php echo urlencode( $permalink ); ?>&amp;media=<?php if ( ! empty( $image[0] ) ) {
        ...
        if ( ! empty( $settings['whatsapp'] ) ) : ?>
            <a rel="nofollow noopener" class="share-action icon-whatsapp is-web" aria-label="<?php esc_attr_e('Share on Whatsapp', 'foxiz-core'); ?>" href="https://web.whatsapp.com/send?text=<?php echo htmlspecialchars( $post_title, ENT_COMPAT, 'UTF-8' ) . ' &#9758; ' . urlencode( $permalink ); ?>" target="_blank" data-title="WhatsApp"<?php echo esc_html( $tipsy_gravity ); ?> rel="nofollow"><i class="rbi rbi-whatsapp" aria-hidden="true"></i><?php if ( ! empty( $settings['social_name'] ) ) {
                    echo '<span>' . foxiz_html__( 'Whatsapp', 'foxiz-core' ) . '</span>';
                } ?></a>
            <a rel="nofollow noopener" class="share-action icon-whatsapp is-mobile" aria-label="<?php esc_attr_e('Share on Whatsapp', 'foxiz-core'); ?>" href="whatsapp://send?text=<?php echo htmlspecialchars( $post_title, ENT_COMPAT, 'UTF-8' ) . ' &#9758; ' . urlencode( $permalink ); ?>" target="_blank" data-title="WhatsApp"<?php echo esc_html( $tipsy_gravity ); ?> rel="nofollow"><i class="rbi rbi-whatsapp" aria-hidden="true"></i><?php if ( ! empty( $settings['social_name'] ) ) {
                    echo '<span>' . foxiz_html__( 'Whatsapp', 'foxiz-core' ) . '</span>';
                } ?></a>
        <?php endif;
        ...
        if ( ! empty( $settings['vk'] ) ) : ?>
            <a rel="nofollow noopener" class="share-action share-trigger icon-vk" aria-label="<?php esc_attr_e('Share on VKontakte', 'foxiz-core'); ?>" href="https://vkontakte.ru/share.php?url=<?php echo urlencode( $permalink ); ?>" data-title="VKontakte" rel="nofollow"><i class="rbi rbi-vk" aria-hidden="true"></i><?php if ( ! empty( $settings['social_name'] ) ) {
        ...
        if ( ! empty( $settings['email'] ) ) :
            ...
            ?>
            <a rel="nofollow noopener" class="share-action icon-email" aria-label="<?php esc_attr_e('Email', 'foxiz-core'); ?>" href="<?php echo esc_url( $mailto ) ?>" data-title="Email"<?php echo esc_html( $tipsy_gravity ); ?> rel="nofollow">
        ...
        if ( ! empty( $settings['copy'] ) && ! foxiz_is_amp() ) : ?>
            <a rel="nofollow noopener" class="share-action icon-copy copy-trigger" aria-label="<?php esc_attr_e('Copy Link', 'foxiz-core'); ?>" href="#" data-copied="<?php foxiz_attr_e( 'Copied!', 'foxiz-core' ); ?>" data-link="<?php echo esc_url( $permalink ); ?>" rel="nofollow" data-copy="<?php foxiz_html_e( 'Copy Link' ); ?>"<?php echo esc_html( $tipsy_gravity ); ?>><i class="rbi rbi-link-o" aria-hidden="true"></i><?php if ( ! empty( $settings['social_name'] ) ) {
                    echo '<span>' . foxiz_html__( 'Copy Link', 'foxiz-core' ) . '</span>';
                } ?></a>
        <?php endif;
        if ( ! empty( $settings['print'] ) && ! foxiz_is_amp() ) : ?>
            <a rel="nofollow noopener" class="share-action icon-print" aria-label="<?php esc_attr_e('Print', 'foxiz-core'); ?>" rel="nofollow" href="javascript:if(window.print)window.print()" data-title="<?php foxiz_html_e( 'Print' ); ?>"<?php echo esc_html( $tipsy_gravity ); ?>><i class="rbi rbi-print" aria-hidden="true"></i><?php if ( ! empty( $settings['social_name'] ) ) {
                    echo '<span>' . foxiz_html__( 'Print', 'foxiz-core' ) . '</span>';
                } ?></a>
        <?php endif;
        if (! empty( $settings['native'] ) && ! foxiz_is_amp() ) : ?>
            <a rel="nofollow noopener" class="share-action native-share-trigger more-icon" aria-label="<?php esc_attr_e('More', 'foxiz-core'); ?>"  href="#" data-link="<?php echo esc_url( $permalink ); ?>" data-ptitle="<?php echo esc_attr( get_the_title() ) ?>" data-title="<?php foxiz_html_e('More', 'foxiz-core'); ?>" <?php echo esc_html( $tipsy_gravity ); ?> rel="nofollow"><i class="rbi rbi-more" aria-hidden="true"></i></a>
        <?php endif;
    }
}