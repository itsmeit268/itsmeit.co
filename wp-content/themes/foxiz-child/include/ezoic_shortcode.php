...
function post_side_bar_top(){
    if (is_allow_show_ads() && aicp_can_see_ads() && free_level()) {
        ...
        <div class="aicp">
            ...
            <!-- End Ezoic - post_side_bar_top - sidebar -->
        </div>
        <?php
    }
}
...
function post_sidebar_bottom(){
    if (is_allow_show_ads() && aicp_can_see_ads() && free_level()) {
        ...
        <!-- End Ezoic - post_sidebar - sidebar_bottom -->
        <?php
    }
}
...
function advertisement_after_more_latest_news() {
    if (is_allow_show_ads() && aicp_can_see_ads() && free_level()) {
        ...
        <div class="aicp">
            ...
            <!-- End Ezoic - advertisement_after_more_latest_news - incontent_6 -->
        </div>
        <?php
    }
}
...
function advertisement_after_more_latest_news_2(){
    if (is_allow_show_ads() && aicp_can_see_ads() && free_level()) {
        ...
        <div class="aicp">
            ...
            <!-- End Ezoic - advertisement_after_more_latest_news_2 - incontent_7 -->
        </div>
        <?php
    }
}
...
function advertisement_after_more_latest_news_bottom(){
    if (is_allow_show_ads() && aicp_can_see_ads() && free_level()) {
        ...
        <div class="aicp">
            ...
            <!-- End Ezoic - advertisement_after_more_latest_news_bottom - incontent_8 -->
        </div>
        <?php
    }
}
...
function advertisement_home_must_read_after(){
    if (is_allow_show_ads() && aicp_can_see_ads() && free_level()) {
        ...
        <div class="aicp">
            ...
            <div id="ezoic-pub-ad-placeholder-172">
            ...
            <!-- End Ezoic - advertisement_home_must_read_after - incontent_9 -->
        </div>
        <?php
    }
}
...
function advertisement_home_more_latest_news(){
    if (is_allow_show_ads() && aicp_can_see_ads() && free_level()) {
        ...
        <div class="aicp">
            ...
            <!-- End Ezoic - advertisement_home_more_latest_news - incontent_10 -->
        </div>
        <?php
    }
}
